...
spec.source       = { :git =>"https://github.com/TLCompany/AddressSearch-iOS.git", :tag => "1.0.3" }

spec.resource = 'AddressSearchModule/Address.storyboard'
spec.resource = 'AddressSearchModule/Assets.xcassets'
