Pod::Spec.new do |spec|
    ...
    spec.source       = { :git =>"https://github.com/TLCompany/AddressSearch-iOS.git", :tag => "1.0.5" }
    spec.swift_version = '5.0'
    spec.resources = ["AddressSearchModule/Address.storyboard"]
    spec.resources = ["AddressSearchModule/Assets.xcassets"]
